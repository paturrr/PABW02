...
{
    // Menampilkan form input perhitungan bangun datar
    public function index()
    {
        return view('indexBangunDatar');
    }

    // Menghitung hasil berdasarkan jenis bangun datar
    public function hitung(Request $request)
    {
        ...
        switch ($bangun) {
            ...
            default:
                $keterangan = "Silakan pilih jenis bangun datar dan isi nilai yang diperlukan.";
                break;
        }

        return view('hasilBangunDatar', compact('bangun', 'hasil', 'keterangan'));
    }
}
